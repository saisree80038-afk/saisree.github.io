...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Alex Morgan — Front-End & Software Developer" },
      { name: "description", content: "Portfolio of Alex Morgan — front-end and software developer building modern, scalable, user-friendly digital experiences with React, Next.js and TypeScript." },
      { name: "author", content: "Alex Morgan" },
      { property: "og:title", content: "Alex Morgan — Front-End & Software Developer" },
