...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Eediga Saisree — Front-End Developer" },
      { name: "description", content: "Eediga Saisree - Front-End Developer. I build responsive websites and dashboards using HTML, CSS, and JavaScript." },
      { name: "author", content: "Eediga Saisree" },
      { property: "og:title", content: "Eediga Saisree — Front-End Developer" },
      { property: "og:description", content: "Eediga Saisree - Front-End Developer. I build responsive websites and dashboards using HTML, CSS, and JavaScript." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Eediga Saisree — Front-End Developer" },
      { name: "twitter:description", content: "Eediga Saisree - Front-End Developer. I build responsive websites and dashboards using HTML, CSS, and JavaScript." },
